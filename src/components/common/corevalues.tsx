...
export default function CoreValues({icon, title, desc, headingsize, boxhoverbar, headinghover}:CoreValuesProp) {
    return(
<>
   <div className="h-full bg-white group border-2 border-black/10 hover:border-[#E53935]/30 p-8 transition-all duration-300 relative overflow-hidden  ">

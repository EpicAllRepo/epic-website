...
export default function PageBanner({subtitle, title , desc}:PageBannerProp) {
    return(
...
<div className="text-center max-w-4xl mx-auto">
  ...
  <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold text-black mb-8 leading-[1.1] tracking-tight">{title}</h1>
  <p className="text-xl text-gray-600 leading-relaxed font-normal max-w-3xl mx-auto">{desc}</p>
<button className="inline-flex items-center gap-2 mt-12 px-8 h-14 bg-white border-2 border-black/10 hover:border-[#E53935] text-black font-semibold transition-all duration-300 group">Back to Home</button>
</div>
</div>
</section>

 ...
 export default function IconText({icon, name, titlename, url}:IconTextProp) {
    return (
        ...
        <div className="flex items-start gap-4">
            <div className="[&_svg]:size-6 [&_svg]:text-white  w-12 h-12 bg-[#E53935] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                {icon}
            </div>

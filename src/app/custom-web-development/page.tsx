        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-8 relative">
            <div className="text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                  <a href="/#contact" className="inline-flex items-center gap-2 px-10 py-5 bg-white text-[#E53935] font-bold hover:bg-gray-100 transition-all duration-300 group text-lg">Contact Us Today <p><FaArrowRight /></p></a>
